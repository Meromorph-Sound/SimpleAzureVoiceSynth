...
#define __AZAC_TRACE_SCOPE(t1, fileName, lineNumber, t2, x, y)                          \
    ...
    auto leavingScopePrinterInMacros = [&evaluateYInScopeInMacros](int*) -> void {      \
        __AZAC_TRACE_INFO(t2, fileName, lineNumber, "%s", evaluateYInScopeInMacros);    \
    };                                                                                  \
...
#define __AZAC_THROW_HR_IMPL(hr) static_assert(false, "__AZAC_THROW_HR_IMPL should be defined elsewhere!")
#endif
